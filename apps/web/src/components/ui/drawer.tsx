...
function DrawerContent({
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      >
        <div
          className="mx-auto mt-4 hidden h-1.5 w-12 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block"
          style={{ background: "oklch(0.4 0.02 280)" }}
        />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
